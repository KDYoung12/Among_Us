...
public class PlayerColor
{
    ...
    private static readonly List<Color> colors = new List<Color>()
    {
        ...
        new Color(0.1f, 0.1f, 1f ,0f),
        new Color(0f, 0.6f, 0f ,0f),
        new Color(1f, 0.3f, 0.9f ,0f),
        new Color(1f, 0.4f, 0f ,0f),
        new Color(1f, 0.9f, 0.1f ,0f),
        new Color(0.2f, 0.2f, 0.2f ,0f),
        new Color(0.9f, 1f, 1f ,0f),
        new Color(0.6f, 0f, 0.6f ,0f),
        new Color(0.35f, 0.2f, 0f ,0f),
        new Color(0f, 1f, 1f ,0f),
        new Color(0.1f, 1f, 0.1f ,0f)
    };
